...
namespace QueToDb.Tests.MSMQ
{
    ...
    public class WriterToReader
    {
        ...
        public void ReadWriteManyMsgInBatch()
        {
            ...
            sw.Stop();
            Console.WriteLine("Messages sent/received In Batch: {0}, in {1}:  msg/sec: {2}", loopCounter, sw.Elapsed, (loopCounter * 1000) / sw.Elapsed.Milliseconds);
        }
